...
export default function Mainweathersectest() {
  ...
  return (
    <View>
      ...
      >
        <TouchableOpacity onPress={() => navigation.navigate("Akurana Weather Station")}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate("Digana Weather Station")}>
          <View style={styles.stationContainer}>
            <View style={styles.locationcontainer}>
              <Image source={locationIcon} style={styles.locationicon} />
              <View style={styles.location}>
            ...
            <View style={styles.weatherContainer}>
              <View>
                <Text style={styles.texttemp}>Temperature: {fahrenheitToCelsius(weatherData['Digana']?.tempf)}°C</Text>
        ...
        <TouchableOpacity onPress={() => navigation.navigate("Nawalapitiya Weather Station")}>
          <View style={styles.stationContainer}>
            <View style={styles.locationcontainer}>
              <Image source={locationIcon} style={styles.locationicon} />
              <View style={styles.location}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate("Alawathugoda Weather Station")}>
          <View style={styles.stationContainer}>
            <View style={styles.locationcontainer}>
              <Image source={locationIcon} style={styles.locationicon} />
              <View style={styles.location}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate("Nachchaduwa Weather Section")}>
          <View style={styles.stationContainer}>
            <View style={styles.locationcontainer}>
              <Image source={locationIcon} style={styles.locationicon} />
              <View style={styles.location}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate("Nuraicholai Weather Station")}>
          <View style={styles.stationContainer}>
            <View style={styles.locationcontainer}>
              <Image source={locationIcon} style={styles.locationicon} />
              <View style={styles.location}>
            ...
            <View style={styles.weatherContainer}>
              <View>
                ...
                <Text style={styles.texttemp}>Humidity: {weatherData['Norochcholai']?.humidityin}%</Text>
