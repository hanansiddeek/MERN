        ...
        <View style={styles.weatherSec}>
          <View style={styles.condition}>
            <View style={styles.conditioncontainer}>
              <Text style={styles.conditionv}>{weatherData.humidity}%</Text>
          ...
          <View style={styles.condition}>
            <View style={styles.conditioncontainer}>
              <Text style={styles.conditionv}>{fahrenheitToCelsius(weatherData.feelsLike)}° C</Text>
          ...
          <View style={styles.condition}>
            <View style={styles.conditioncontainer}>
              <Text style={styles.conditionv}>{weatherData.windspeedmph} mph</Text>
              <Text style={styles.conditiontext}>Wind Speed</Text>
            </View>
