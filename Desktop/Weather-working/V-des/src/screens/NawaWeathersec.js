...
import NawaDashboard from '../componentstest/NawaDashboard';
...
export default function NawaWeathersec() {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.contentContainer}>
          <View style={styles.locationcontainer}>
            ...
            <Text style={styles.textlocation1}>Nawalapitiya,</Text>
          ...
          <NawaDashboard style={styles.dashboard} />
        </View>
        ) : (
