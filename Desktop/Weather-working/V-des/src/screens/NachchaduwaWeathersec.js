...
import NachchaduwaDashboard from '../componentstest/NachchaduwaDashboard';
...
export default function NachchaduwaWeathersec() {
  ...
  const targetMacAddress = "3C:71:BF:3E:A2:5A";
  ...
  useEffect(() => {
    ...
    socket.on('data', (data) => {
      ...
      if (data.macAddress === targetMacAddress) {
  ...
  }, [apiKey, socketUrl,targetMacAddress]);
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.contentContainer}>
          <View style={styles.locationcontainer}>
            ...
            <Text style={styles.textlocation1}>Nachchaduwa,</Text>
          ...
          <NachchaduwaDashboard style={styles.dashboard} />
        </View>
        ) : (
