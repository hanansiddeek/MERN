...
import AlaDashboard from '../componentstest/AlaDashboard';
...
export default function AlaWeathersec() {
  ...
  useEffect(() => {
    ...
    socket.on('data', (data) => {
      // Only log data for the specified macAddress
      if (data.macAddress === "40:F5:20:3A:F5:AB") {
        console.log('Data for state:', JSON.stringify(data, null, 2)); // Stringify and pretty-print the data object
        setWeatherData(data);
      }
    });
        ...
        <View style={styles.contentContainer}>
          <View style={styles.locationcontainer}>
            ...
            <View style={styles.location}>
              <Text style={styles.textlocation1}>Alawatugoda,</Text>
          ...
          <AlaDashboard style={styles.dashboard} />
        </View>
      ) : (
