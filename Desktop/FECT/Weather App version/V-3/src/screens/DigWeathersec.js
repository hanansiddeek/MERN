...
import AkuDashboard from '../componentstest/AkuDashboard';
import DigDashboard from '../componentstest/DigDashboard';
...
export default function DigWeathersec() {
  ...
  useEffect(() => {
    ...
    socket.on('data', (data) => {
      ...
      if (data.macAddress === "80:7D:3A:7C:4A:7F") {
        ...
        <View style={styles.contentContainer}>
          <View style={styles.locationcontainer}>
            ...
            <View style={styles.location}>
              <Text style={styles.textlocation1}>Digana,</Text>
          ...
          <View style={styles.weatherContainer}>
            <Text style={styles.texttemp}>{fahrenheitToCelsius(weatherData.tempf)}°C</Text>
            <View style={styles.datecontainer}>
              <Text style={{ fontSize: 14, textAlign: 'left' }}>{todayDate}</Text>
            </View>
            {/*
          ...
          <DigDashboard style={styles.dashboard} />
        </View>
      ) : (
